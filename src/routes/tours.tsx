...
export const Route = createFileRoute("/tours")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "All India tour packages — Kashmir, Kerala, Sikkim, Rajasthan, Goa, Ladakh & more. Region-wise itineraries with WhatsApp quotes." },
      { property: "og:title", content: "India Tours — Voyago India" },
      { property: "og:description", content: "Region-wise India holiday packages with instant WhatsApp booking." },
    ],
  }),
  component: ToursPage,
});
