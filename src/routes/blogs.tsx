...
export const Route = createFileRoute("/blogs")({
  head: () => ({
    meta: [
      { title: "Travel Blogs & Guides — Voyago India" },
      { name: "description", content: "Destination guides, itineraries and travel inspiration from Voyago India." },
      { property: "og:title", content: "Travel Blogs — Voyago India" },
      { property: "og:description", content: "Cinematic travel stories, guides and itineraries for Indian travelers." },
    ],
  }),
  component: BlogsPage,
});
