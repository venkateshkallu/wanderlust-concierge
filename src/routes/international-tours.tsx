...
export const Route = createFileRoute("/international-tours")({
  head: () => ({
    meta: [
      { title: "International Tours — Dubai, Bali, Maldives & More | Voyago India" },
      { name: "description", content: "Premium international holiday packages from India — Dubai, Bali, Thailand, Maldives, Singapore, Switzerland." },
      { property: "og:title", content: "International Tours — Voyago India" },
      { property: "og:description", content: "Curated international travel from India with WhatsApp quotes." },
    ],
  }),
